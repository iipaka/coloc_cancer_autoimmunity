# ==============================================================================
# Purpose: Master loop for coloc analysis across all target regions (Centered)
# ==============================================================================
...
for(i in seq_along(eqtl_files)) {
  ...
  target_row <- sig_snps[sig_snps$New_Centre_SNP == rsid, ]
  target_row <- target_row[1, ]
  
  target_chr <- target_row$CHR 
  target_pos <- target_row$New_Centre_POS 
  trait_name <- target_row$Stronger_Trait 
