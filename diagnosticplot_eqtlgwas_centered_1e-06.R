# ==============================================================================
# Purpose: Generate diagnostic plots (P-value & Z-score); GWAS-EQTL (Centered)
# ==============================================================================
...
p_threshold <- "1e-06"
out_dir <- paste0("Output/Diagnostic_Plots_eQTL_", p_threshold, "_centered")
...
for(i in 1:nrow(lead_coloc_snps)) {
  ...
  plot_file <- file.path(out_dir, paste0("Diagnostic_", rsid, "_", trait_name, "_vs_", gene_name, ".png"))
